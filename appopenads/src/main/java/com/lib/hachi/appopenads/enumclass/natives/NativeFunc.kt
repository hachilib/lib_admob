package com.lib.hachi.appopenads.enumclass.natives
...
import com.lib.hachi.appopenads.R
import com.lib.hachi.appopenads.databinding.AdUnifiedBinding
   ...
   companion object {
        fun populateNativeAdView(
            ...
            if (nativeAd.mediaContent != null) {
                if (size == GoogleSizeNative.UNIFIED_MEDIUM) {
